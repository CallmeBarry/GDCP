 ...
 */
public class GDFragment   extends BaseFragment implements JSJFragmentView {
    ...
    protected void init() {
        super.init();
        JSJFragmentPresenter JSJFragmentPresenter = new JSJFragmentPresenterImpl(this,"http://gdxy.gdcp.cn/");
