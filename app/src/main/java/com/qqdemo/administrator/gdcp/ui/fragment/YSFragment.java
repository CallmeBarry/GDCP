 ...
 */
public class YSFragment  extends BaseFragment implements JSJFragmentView {
    ...
    protected void init() {
        super.init();
        JSJFragmentPresenter JSJFragmentPresenter = new JSJFragmentPresenterImpl(this,"http://wlysxy.gdcp.cn/");
