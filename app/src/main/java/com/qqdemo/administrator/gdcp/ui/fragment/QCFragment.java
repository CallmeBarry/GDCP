 ...
 */
public class QCFragment extends BaseFragment implements JSJFragmentView {
    ...
    protected void init() {
        super.init();
        JSJFragmentPresenter JSJFragmentPresenter = new JSJFragmentPresenterImpl(this,"http://qcxy.gdcp.cn/");
