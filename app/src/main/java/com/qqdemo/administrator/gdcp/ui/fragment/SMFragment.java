 ...
 */
public class SMFragment extends BaseFragment implements JSJFragmentView {
    ...
    protected void init() {
        super.init();
        JSJFragmentPresenter JSJFragmentPresenter = new JSJFragmentPresenterImpl(this, "http://smxy.gdcp.cn/");
