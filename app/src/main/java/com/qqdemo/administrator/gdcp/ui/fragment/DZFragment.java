 ...
 */
public class DZFragment  extends BaseFragment implements JSJFragmentView {
    ...
    protected void init() {
        super.init();
        JSJFragmentPresenter JSJFragmentPresenter = new JSJFragmentPresenterImpl(this,"http://xxxy.gdcp.cn/");
